...
void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = MPU6000_SPI_SCK_Pin|MPU6000_SPI_MOSI_Pin;
  ...
  GPIO_InitStruct.Pin = MPU6000_SPI_MISO_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_5;
  LL_GPIO_Init(MPU6000_SPI_MISO_GPIO_Port, &GPIO_InitStruct);
...
void MX_SPI3_Init(void)
{
  ...
  PB5   ------> SPI3_MOSI
  */
  GPIO_InitStruct.Pin = BNO085_SPI_SCK_Pin|BNO085_SPI_MISO_Pin|BNO085_SPI_MOSI_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
